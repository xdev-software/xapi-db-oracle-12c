...
## Releasing [![Build](https://img.shields.io/github/actions/workflow/status/xdev-software/xapi-db-oracle-12c/release.yml?branch=master)](https://github.com/xdev-software/xapi-db-oracle-12c/actions/workflows/release.yml)
